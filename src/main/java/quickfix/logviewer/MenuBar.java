...
public class MenuBar extends javax.swing.JMenuBar implements ActionListener {
	...
	public static final JCheckBoxMenuItem filterAdministrativeMessages = new JCheckBoxMenuItem(
	...
	public static final JCheckBoxMenuItem filterEventCommunicationCategory = new JCheckBoxMenuItem(
			"Event Communication");
	public static final JCheckBoxMenuItem filterQuotationNegotiationCategory = new JCheckBoxMenuItem(
			"Quotation/Negotiation");
	public static final JCheckBoxMenuItem filterMarketDataCategory = new JCheckBoxMenuItem("Market Data");
	public static final JCheckBoxMenuItem filterSecurityAndTradingSessionCategory = new JCheckBoxMenuItem(
			"Security And Trading Session");
	public static final JCheckBoxMenuItem filterSingleGeneralOrderHandlingCategory = new JCheckBoxMenuItem(
	...
	public static final JCheckBoxMenuItem filterListProgramBasketTradingCategory = new JCheckBoxMenuItem(
	...
	public static final JCheckBoxMenuItem filterSettlementInstructionsCategory = new JCheckBoxMenuItem(
			"Settlement Instructions");
	public static final JCheckBoxMenuItem filterTradeCaptureReportingCategory = new JCheckBoxMenuItem(
			"Trade Capture Reporting");
	public static final JCheckBoxMenuItem filterRegistrationInstructionsCategory = new JCheckBoxMenuItem(
			"Registration Instructions");
	public static final JCheckBoxMenuItem filterPositionsMaintenanceCategory = new JCheckBoxMenuItem(
			"Positions Maintenance");
	public static final JCheckBoxMenuItem filterCollateralManagementCategory = new JCheckBoxMenuItem(
