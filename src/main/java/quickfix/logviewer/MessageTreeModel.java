...
public class MessageTreeModel implements TreeModel {
	...
	private ArrayList<Node> headerFields = new ArrayList<Node>();
	private ArrayList<Node> bodyFields = new ArrayList<Node>();
	private ArrayList<Node> trailerFields = new ArrayList<Node>();
